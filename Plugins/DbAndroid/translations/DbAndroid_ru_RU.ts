...
<context>
    ...
    <message>
        ...
        <translation type="vanished">JAR-файл адаптера для Android можно получить в меню Инструменты. Он необходим для 2 из 3 типов подключений, поддерживаемых модулем для Android. Подробности см. в документации к модулю &lt;a href=&quot;%1&quot;&gt;на вики-странице SQLiteStudio.&lt;/a&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">&lt;p&gt;Это пароль, настроенный в службе SQLiteStudio, входящей в состав приложения для Android.&lt;/p&gt;</translation>
    </message>
    <message>
