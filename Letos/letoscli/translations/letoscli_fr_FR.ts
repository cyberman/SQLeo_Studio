...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Imprimez la liste des bases de données enregistrées sous SQLiteStudio. Chaque base se données de la liste peut être ouverte ou fermée et %1 vous indique ceci. La base de données courante est aussi marquée dans la liste par « * » en début de nom. Voir l’aide la commande %2 pour en savoir plus sur la base de données courante.</translation>
    </message>
</context>
<context>
...
You can always execute any command with exactly single &apos;--help&apos; option to see help for that command. It&apos;s an alternative for typing: %1 &lt;command&gt;.</source>
        <translation type="vanished">Utilisez %1 pour connaitre certaines commandes supportées par la ligne de commande (CLI) de SQLiteStudio.
...
When -s option is given, then also system objects will be printed (sqlite_* tables, autoincrement indexes, etc).
The database argument is optional and if provided, then only given database will be printed. This is not a registered database name, but instead it&apos;s an internal SQLite database name, like &apos;main&apos;, &apos;temp&apos;, or any attached database name. To print tree for other registered database, call %1 first to switch the working database, and then use %2 command.</source>
        <translation type="vanished">Imprime tous les objets (tables, index, déclencheurs et vues) qui sont dans la base de données en tant qu&apos;arbre. L’arbre est très semblable à celui que vous pouvez voir dans le GUI client de SQLiteStudio.
...
Expected one of: %2</source>
    ...
    <message>
        ...
        <translation type="vanished">Interface de ligne de commandes de SQLiteStudio, SQLite manager.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Liste les plugins installés dans SQLiteStudio et quitte.</translation>
    </message>
    <message>
        ...
        <translation type="vanished">Exécute le fichier SQL fourni (y compris toutes les fonctionnalités riches de l&apos;exécuteur de requête SQLiteStudio) sur le fichier de base de données spécifié et quitte. Le paramètre de la base de données devient obligatoire si cette option est utilisée.</translation>
    </message>
    <message>
