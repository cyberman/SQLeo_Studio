...
You can always execute any command with exactly single &apos;--help&apos; option to see help for that command. It&apos;s an alternative for typing: %1 &lt;command&gt;.</source>
        <translation type="vanished">Używaj %1 aby poznać poszczególne polecenia obsługiwane przez interfejs linii poleceń (CLI) SQLiteStudio.
...
When -s option is given, then also system objects will be printed (sqlite_* tables, autoincrement indexes, etc).
The database argument is optional and if provided, then only given database will be printed. This is not a registered database name, but instead it&apos;s an internal SQLite database name, like &apos;main&apos;, &apos;temp&apos;, or any attached database name. To print tree for other registered database, call %1 first to switch the working database, and then use %2 command.</source>
        <translation type="vanished">Wypisuje wszystkie obiekty (tabele, indeksy, wyzwalacze i widoki) znajdujące się w bazie danych w postaci drzewa. Drzewo to jest podobne do tego, które można zobaczyć w interfejsie graficznym SQLiteStudio.
...
Oczekiwano jednej z: %2</translation>
    ...
    <message>
        ...
        <translation type="vanished">Interfejs linii poleceń dla SQLiteStudio, menażera SQLite.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Wypisuje listę zainstalowanych w SQLiteStudio wtyczek i wychodzi.</translation>
    </message>
    <message>
        ...
        <translation type="vanished">Wykonuje podany plik SQL (w tym wszystkie bogate funkcje wykonywania zapytań w SQLiteStudio) na określonym pliku bazy danych i wychodzi z programu. Parametr bazy danych staje się obowiązkowy, jeśli ta opcja jest używana.</translation>
    </message>
    <message>
