...
You can always execute any command with exactly single &apos;--help&apos; option to see help for that command. It&apos;s an alternative for typing: %1 &lt;command&gt;.</source>
        <translation type="vanished">Usa %1 per conoscere alcuni comandi supportati dall&apos;interfaccia a linea di comando (CLI) di Sqlitestudio.
...
When -s option is given, then also system objects will be printed (sqlite_* tables, autoincrement indexes, etc).
The database argument is optional and if provided, then only given database will be printed. This is not a registered database name, but instead it&apos;s an internal SQLite database name, like &apos;main&apos;, &apos;temp&apos;, or any attached database name. To print tree for other registered database, call %1 first to switch the working database, and then use %2 command.</source>
        <translation type="vanished">Stampa tutti gli oggetti (tabelle, indici, trigger e viste) che si trovano nel database come albero. L&apos;albero è molto simile a quello che si può vedere nel client GUI di SQLiteStudio.
...
Atteso uno di: %2</translation>
    ...
    <message>
        ...
        <translation type="vanished">Interfaccia a riga di comando per SQLiteStudio, un gestore SQLite.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Elenca i plugin installati in SQLiteStudio ed esce.</translation>
    </message>
    <message>
        ...
        <translation type="vanished">Esegue il file SQL fornito (incluse tutte le ricche caratteristiche dell&apos;esecutore delle query di SQLiteStudio) sul file di database specificato e termina. Il parametro del database diventa obbligatorio se viene utilizzata questa opzione.</translation>
    </message>
    <message>
