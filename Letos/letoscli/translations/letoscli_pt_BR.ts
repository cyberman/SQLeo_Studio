...
You can always execute any command with exactly single &apos;--help&apos; option to see help for that command. It&apos;s an alternative for typing: %1 &lt;command&gt;.</source>
        <translation type="vanished">Use %1 para aprender sobre certos comandos suportados pela interface de linha de comando (CLI) do SQLiteStudio.
...
When -s option is given, then also system objects will be printed (sqlite_* tables, autoincrement indexes, etc).
The database argument is optional and if provided, then only given database will be printed. This is not a registered database name, but instead it&apos;s an internal SQLite database name, like &apos;main&apos;, &apos;temp&apos;, or any attached database name. To print tree for other registered database, call %1 first to switch the working database, and then use %2 command.</source>
        <translation type="vanished">Imprime todos os objetos (tabelas, indexes, gatilhos e visualizações) que estão no banco de dados como uma árvore. A árvore é muito parecida com a que você pode ver no cliente GUI do SQLiteStudio.
...
Espera-se um de: %2</translation>
    ...
    <message>
        ...
        <translation type="vanished">Interface da linha de comando para SQLiteStudio, um gerenciador para SQLite.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Lista os plugins instalados no SQLiteStudio e encerrados.</translation>
    </message>
    <message>
        ...
        <translation type="vanished">Executa o arquivo SQL fornecido (incluindo todos os recursos avançados do executor de consulta SQLiteStudio &apos;s) no arquivo de banco de dados especificado e fecha a rotina. O parâmetro do banco de dados torna-se obrigatório se esta opção for utilizada.</translation>
    </message>
    <message>
