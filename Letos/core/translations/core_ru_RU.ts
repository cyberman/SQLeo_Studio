...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Невозможно присоединить базу данных %1 к базе данных %2, поэтому данные таблицы %3 будут скопированы при посредничестве SQLiteStudio. Этот метод может быть медленным для больших таблиц, так что наберитесь терпения.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Функция не зарегистрирована в SQLiteStudio: %1(%2)</translation>
    </message>
    <message>
...
Представление останется как есть.</translation>
    ...
    <message>
        ...
        <translation type="vanished">SQLiteStudio не удалось определить столбцы, возвращаемые новым представлением, поэтому невозможно указать, какие триггеры могут сломаться в процессе воссоздания.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="vanished">SQLiteStudio не удалось извлечь метаданные из запроса. Результаты нельзя будет редактировать.</translation>
    </message>
</context>
<context>
