...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Неможливо приєднати базу даних %1 до бази даних %2, тому дані таблиці %3 будуть скопійовані за допомогою SQLiteStudio. Цей метод може бути повільним для великих таблиць, так що наберіться терпіння.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">Немає такої функції, зареєстрованої в SQLiteStudio: %1(%2)</translation>
    </message>
    <message>
...
Вид залишиться таким, як є.</translation>
    ...
    <message>
        ...
        <translation type="vanished">SQLiteStudio не вдалося визначити стовпці, які повертаються новим розрізом даних (view), тому неможливо вказати, які тригери можуть зламатися в процесі відтворення.</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation type="vanished">SQLiteStudio не вдалося витягти метадані із запиту. Результат не зможе бути редагованим.</translation>
    </message>
</context>
<context>
